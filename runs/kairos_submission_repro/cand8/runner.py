...
def main():
    ...
    spec = importlib.util.spec_from_file_location('candidate', '/Users/twishamehta/tiktok/kuairand-starter-kit/runs/kairos_submission_repro/cand8/candidate.py')
    ...
    np.save('/Users/twishamehta/tiktok/kuairand-starter-kit/runs/kairos_submission_repro/cand8/X.npy', X)
    json.dump({'names': list(names), 'seconds': round(time.time()-t0,1),
               'train_cfg': dict(cfg or {})}, open('/Users/twishamehta/tiktok/kuairand-starter-kit/runs/kairos_submission_repro/cand8/meta.json', 'w'))
    print("OK")
try:
    main()
except Exception:
