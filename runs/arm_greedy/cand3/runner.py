...
def main():
    ...
    spec = importlib.util.spec_from_file_location('candidate', '/Users/twishamehta/tiktok/kuairand-starter-kit/runs/arm_greedy/cand3/candidate.py')
    ...
    np.save('/Users/twishamehta/tiktok/kuairand-starter-kit/runs/arm_greedy/cand3/X.npy', X)
    json.dump({'names': list(names), 'seconds': round(time.time()-t0,1),
               'train_cfg': dict(cfg or {})}, open('/Users/twishamehta/tiktok/kuairand-starter-kit/runs/arm_greedy/cand3/meta.json', 'w'))
    print("OK")
try:
    main()
except Exception:
